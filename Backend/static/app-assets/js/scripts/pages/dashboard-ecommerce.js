...
$(window).on('load', function () {
  ...
  var $salesRevenueChart = document.querySelector('#sales-revenue-chart');
  var $salesConversionRatioChart = document.querySelector('#sales-conversion-ratio-chart');
  var $salesMonthlyLeadsTrackingChart = document.querySelector('#sales-monthly-leads-tracking-chart');
  ...
  var salesRevenueChartOptions;
  var salesConversionRatioChartOptions;
  var salesMonthlyLeadsTrackingChartOptions;
  ...
  var salesConversionRatioChart;
  var salesMonthlyLeadsTrackingChart;
  ...
  if ($salesRevenueChart) { 
    salesRevenueChart = new ApexCharts($salesRevenueChart, salesRevenueChartOptions);
    salesRevenueChart.render();
  }
 
  //--------------- Sales Conversion Ratio Chart ---------------
  //---------------------------------------------- 
  salesConversionRatioChartOptions = {
    chart: {
      type: 'donut',
      height: 120,
      toolbar: {
  ...
  if ($salesConversionRatioChart) {
    salesConversionRatioChart = new ApexCharts($salesConversionRatioChart, salesConversionRatioChartOptions);
    salesConversionRatioChart.render(); 
  }
  
  //------------ Sales Monthly Leads Tracking Chart ------------
  //----------------------------------------------
  salesMonthlyLeadsTrackingChartOptions = {
    chart: {
      height: 230,
      stacked: true,
      type: 'bar',
    ...
    series: [
      {
        name: 'Profit',
        data: [95, 177, 284, 256, 105, 63, 168, 218, 284, 256, 105, 72]
      },
      {
        name: 'Loss',
        data: [-145, -80, -60, -180, -100, -60, -85, -75, -180, -100, -60, -100]
      }
    ],
    dataLabels: {
      enabled: false
  ...
  if ($salesMonthlyLeadsTrackingChart) {
    salesMonthlyLeadsTrackingChart = new ApexCharts($salesMonthlyLeadsTrackingChart, salesMonthlyLeadsTrackingChartOptions);
    salesMonthlyLeadsTrackingChart.render();
  }
