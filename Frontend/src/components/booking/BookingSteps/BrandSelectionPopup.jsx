...
const BrandSelectionPopup = ({ isOpen, onClose, onBrandSelect }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
      <div className={`w-full h-full overflow-hidden flex flex-col ${theme === 'light' ? 'bg-white' : 'bg-gray-800'}`}>
        {/* Header */}
        <div className={`p-4 sm:p-6 border-b ${theme === 'light' ? 'border-gray-200' : 'border-gray-700'}`}>
        ...
        {/* Content */}
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 min-h-0 pb-10">
          {loading ? (
