...
const FourWheelerGarages = ({ selectedCity, filterData, onVehicleTypeChange }) => {
      ...
      <div className={`py-12 px-4 ${theme === 'light' ? 'bg-white' : 'bg-black'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className={`mt-4 ${theme === 'light' ? 'text-gray-700' : 'text-gray-400'}`}>Loading four-wheeler garages...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className={`${isFilterOpen ? 'lg:col-span-3' : 'col-span-1 lg:col-span-3'}`}>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 overflow-x-hidden relative z-20">
                ...
                <div className="text-center py-12">
                  <p className={`text-sm md:text-base mb-4 ${theme === 'light' ? 'text-gray-600' : 'text-gray-400'}`}>
                    {garageType === 'authorized'
                      ...
                      : 'No four-wheeler garages found matching your criteria.'}
                  </p>
                  <button
