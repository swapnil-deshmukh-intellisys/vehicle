    ...
    <footer className={`${theme === 'light' ? 'bg-white text-black' : 'bg-black text-white'}`}>
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links space-y-2">
              <li><button onClick={handleHomeClick} className={`text-sm md:text-base transition-colors ${theme === 'light' ? '!text-black visited:!text-black hover:!text-black' : 'text-gray-300 hover:text-red-500'}`}>Home</button></li>
              ...
              <li><button onClick={() => handleNavClick('/about')} className={`text-sm md:text-base transition-colors ${theme === 'light' ? '!text-black visited:!text-black hover:!text-black' : 'text-gray-300 hover:text-red-500'}`}>About Us</button></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-links space-y-2">
              <li><button onClick={() => handleNavClick('/contact')} className={`text-sm md:text-base transition-colors ${theme === 'light' ? '!text-black visited:!text-black hover:!text-black' : 'text-gray-300 hover:text-red-500'}`}>Contact Us</button></li>
        ...
        <div className={`footer-bottom mt-6 md:mt-8 pt-4 md:pt-6 border-t ${theme === 'light' ? 'border-gray-200' : 'border-gray-800'}`}>
          ...
          <p className={`text-center text-xs md:text-sm mt-1 ${theme === 'light' ? 'text-black' : 'text-gray-400'}`}>Call us: +91 9112025454</p>
        </div>
      </div>
    </footer>
  )
